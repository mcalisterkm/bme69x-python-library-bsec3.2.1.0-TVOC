                            ...
                            else
                            {
                                ...
                                for (uint8_t index = 0; index < n_output; index++)
                                {
                                    ...
                                    case BSEC_OUTPUT_TVOC_EQUIVALENT:
                                        PyDict_SetItemString(bsec_data, "tvoc_equivalent", Py_BuildValue("d", bsec_outputs[index].signal));
                                        PyDict_SetItemString(bsec_data, "tvoc_equivalent_accuracy", Py_BuildValue("i", bsec_outputs[index].accuracy));
                                        break;
